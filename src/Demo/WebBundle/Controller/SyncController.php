...
//        $url = "http://api.duoshuo.com/log/list.json?short_name=lattecake&secret=c9d92470f13da30f2da8f48a4f4e167a&since_id=0&limit=&order=asc";
//
//        $response = $this->getUrlContent($url);
        ...
        /*[log_id] => 1259580729570885633
        [user_id] => 661480
        [action] => create
        [meta] => Array
            (
                [post_id] => 1259580729570885704
                [thread_id] => 1259580729570885633
                [thread_key] => 请将此处替换成文章在你的站点中的ID
                [author_id] => 661480
                [author_key] =>
                [author_name] => 聪_cowa
                [author_email] =>
                [author_url] => http://weibo.com/solacowa
                [ip] => 113.45.197.18
                [created_at] => 2015-01-11T11:50:16+08:00
                [message] => 测试 "[哈哈]"
            [status] => approved
                [type] =>
                [parent_id] => 1259580729570885632
                [agent] => Mozilla/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2267.0 Safari/537.36
            )
